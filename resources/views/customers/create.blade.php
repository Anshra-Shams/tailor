    ...
    <form method="POST" action="{{ route('customers.store') }}">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-6 pt-2">
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="gender" value="male" {{ old('gender') == 'male' ? 'checked' : '' }} class="w-4 h-4 text-indigo-600 border-slate-300 focus:ring-indigo-500">
        ...
        <div class="mt-6 space-y-4">
            ...
            <template x-for="(member, index) in members" :key="index">
                <div class="bg-white rounded-2xl border border-slate-200 p-5 relative group" x-transition>
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-semibold text-slate-700" x-text="'Member ' + (index + 1)"></span>
                        </div>
